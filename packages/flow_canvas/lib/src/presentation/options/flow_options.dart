...
import 'package:flow_canvas/src/presentation/options/components/keyboard_options.dart';
import 'package:flow_canvas/src/presentation/options/components/node_options.dart';
...
class FlowCanvasOptions with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Size>('canvasSize', canvasSize));
    properties
