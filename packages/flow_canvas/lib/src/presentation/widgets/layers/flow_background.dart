...
import 'package:flow_canvas/src/presentation/theme/theme_extension.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';
import 'package:flow_canvas/src/presentation/painters/background_painter.dart';
...
final _shaderProvider = FutureProvider<ui.FragmentProgram>((ref) {
  return ui.FragmentProgram.fromAsset(
    'packages/flow_canvas/lib/src/presentation/shaders/background.frag',
  );
});
