...
import 'package:flow_canvas/src/features/minimap/presentation/painters/minimap_painter.dart';
import 'package:flow_canvas/src/core/theme/components/minimap_theme.dart';
import 'package:flow_canvas/src/core/theme/theme_extension.dart';
...
class FlowMiniMap extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final viewModel = ref.watch(internalControllerProvider.select((s) {
      ...
      final renderTopLeft = viewportService.screenToCanvas(s, Offset.zero);
      final topLeft = coordinateConverter.toCartesianPosition(renderTopLeft);

      final renderBottomRight = viewportService.screenToCanvas(
          s, Offset(viewportSize.width, viewportSize.height));
      final bottomRight =
          coordinateConverter.toCartesianPosition(renderBottomRight);
