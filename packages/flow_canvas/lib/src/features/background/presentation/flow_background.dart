...
import 'package:flow_canvas/src/features/background/presentation/painters/background_painter.dart';
...
final _shaderProvider = FutureProvider<ui.FragmentProgram>((ref) {
  return ui.FragmentProgram.fromAsset(
    'packages/flow_canvas/lib/src/features/background/presentation/shaders/background.frag',
  );
});
